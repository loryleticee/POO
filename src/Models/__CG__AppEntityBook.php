...
class Book extends \App\Entity\Book implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Book' . "\0" . 'available'];
        }
    ...
    public function isBorrowable(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isBorrowable', []);

        return parent::isBorrowable();
    }
     ...
     * {@inheritDoc}
     */
    public function setAuthor(string $author): \App\Entity\Volume
    {
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\Document
    {
